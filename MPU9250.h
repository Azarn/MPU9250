...
template<uint8_t A, IO_FLAG F, REG_TYPE R, typename T=uint8_t>
...
template<uint8_t A, IO_FLAG F, REG_TYPE R>
struct REGISTER_DESCRIPTION<A, F, R, uint8_t> {
    union DATA {
        uint8_t Raw;
        DATA(uint8_t value) : Raw(value) {};
        DATA() : DATA(0) {};
...
using SELF_TEST_X_GYRO = REGISTER_DESCRIPTION<0x00, IO_FLAG::RW, REG_TYPE::GEN>;
using SELF_TEST_Y_GYRO = REGISTER_DESCRIPTION<0x01, IO_FLAG::RW, REG_TYPE::GEN>;
using SELF_TEST_Z_GYRO = REGISTER_DESCRIPTION<0x02, IO_FLAG::RW, REG_TYPE::GEN>;
using SELF_TEST_X_ACCEL = REGISTER_DESCRIPTION<0x0D, IO_FLAG::RW, REG_TYPE::GEN>;
using SELF_TEST_Y_ACCEL = REGISTER_DESCRIPTION<0x0E, IO_FLAG::RW, REG_TYPE::GEN>;
using SELF_TEST_Z_ACCEL = REGISTER_DESCRIPTION<0x0F, IO_FLAG::RW, REG_TYPE::GEN>;
using XG_OFFSET_H = REGISTER_DESCRIPTION<0x13, IO_FLAG::RW, REG_TYPE::GEN>;
using XG_OFFSET_L = REGISTER_DESCRIPTION<0x14, IO_FLAG::RW, REG_TYPE::GEN>;
using YG_OFFSET_H = REGISTER_DESCRIPTION<0x15, IO_FLAG::RW, REG_TYPE::GEN>;
using YG_OFFSET_L = REGISTER_DESCRIPTION<0x16, IO_FLAG::RW, REG_TYPE::GEN>;
using ZG_OFFSET_H = REGISTER_DESCRIPTION<0x17, IO_FLAG::RW, REG_TYPE::GEN>;
using ZG_OFFSET_L = REGISTER_DESCRIPTION<0x18, IO_FLAG::RW, REG_TYPE::GEN>;
using SMPLRT_DIV = REGISTER_DESCRIPTION<0x19, IO_FLAG::RW, REG_TYPE::GEN>;
using CONFIG = REGISTER_DESCRIPTION<0x1A, IO_FLAG::RW, REG_TYPE::GEN, CONFIG_DATA>;
using GYRO_CONFIG = REGISTER_DESCRIPTION<0x1B, IO_FLAG::RW, REG_TYPE::GEN, GYRO_CONFIG_DATA>;
using ACCEL_CONFIG = REGISTER_DESCRIPTION<0x1C, IO_FLAG::RW, REG_TYPE::GEN, ACCEL_CONFIG_DATA>;
using ACCEL_CONFIG2 = REGISTER_DESCRIPTION<0x1D, IO_FLAG::RW, REG_TYPE::GEN, ACCEL_CONFIG2_DATA>;
using LP_ACCEL_ODR = REGISTER_DESCRIPTION<0x1E, IO_FLAG::RW, REG_TYPE::GEN, LP_ACCEL_ODR_DATA>;
using WOM_THR = REGISTER_DESCRIPTION<0x1F, IO_FLAG::RW, REG_TYPE::GEN>;
using FIFO_EN = REGISTER_DESCRIPTION<0x23, IO_FLAG::RW, REG_TYPE::GEN, FIFO_EN_DATA>;
using I2C_MST_CTRL = REGISTER_DESCRIPTION<0x24, IO_FLAG::RW, REG_TYPE::GEN, I2C_MST_CTRL_DATA>;
using I2C_SLV0_ADDR = REGISTER_DESCRIPTION<0x25, IO_FLAG::RW, REG_TYPE::GEN, I2C_SLV_ADDR_DATA>;
using I2C_SLV0_REG = REGISTER_DESCRIPTION<0x26, IO_FLAG::RW, REG_TYPE::GEN>;
using I2C_SLV0_CTRL = REGISTER_DESCRIPTION<0x27, IO_FLAG::RW, REG_TYPE::GEN, I2C_SLV_CTRL_DATA>;
using I2C_SLV1_ADDR = REGISTER_DESCRIPTION<0x28, IO_FLAG::RW, REG_TYPE::GEN, I2C_SLV_ADDR_DATA>;
using I2C_SLV1_REG = REGISTER_DESCRIPTION<0x29, IO_FLAG::RW, REG_TYPE::GEN>;
using I2C_SLV1_CTRL = REGISTER_DESCRIPTION<0x2A, IO_FLAG::RW, REG_TYPE::GEN, I2C_SLV_CTRL_DATA>;
using I2C_SLV2_ADDR = REGISTER_DESCRIPTION<0x2B, IO_FLAG::RW, REG_TYPE::GEN, I2C_SLV_ADDR_DATA>;
using I2C_SLV2_REG = REGISTER_DESCRIPTION<0x2C, IO_FLAG::RW, REG_TYPE::GEN>;
using I2C_SLV2_CTRL = REGISTER_DESCRIPTION<0x2D, IO_FLAG::RW, REG_TYPE::GEN, I2C_SLV_CTRL_DATA>;
using I2C_SLV3_ADDR = REGISTER_DESCRIPTION<0x2E, IO_FLAG::RW, REG_TYPE::GEN, I2C_SLV_ADDR_DATA>;
using I2C_SLV3_REG = REGISTER_DESCRIPTION<0x2F, IO_FLAG::RW, REG_TYPE::GEN>;
using I2C_SLV3_CTRL = REGISTER_DESCRIPTION<0x30, IO_FLAG::RW, REG_TYPE::GEN, I2C_SLV_CTRL_DATA>;
using I2C_SLV4_ADDR = REGISTER_DESCRIPTION<0x31, IO_FLAG::RW, REG_TYPE::GEN, I2C_SLV_ADDR_DATA>;
using I2C_SLV4_REG = REGISTER_DESCRIPTION<0x32, IO_FLAG::RW, REG_TYPE::GEN>;
using I2C_SLV4_DO = REGISTER_DESCRIPTION<0x33, IO_FLAG::RW, REG_TYPE::GEN>;
using I2C_SLV4_CTRL = REGISTER_DESCRIPTION<0x34, IO_FLAG::RW, REG_TYPE::GEN, I2C_SLV4_CTRL_DATA>;
using I2C_SLV4_DI = REGISTER_DESCRIPTION<0x35, IO_FLAG::R, REG_TYPE::GEN>;
using I2C_MST_STATUS = REGISTER_DESCRIPTION<0x36, IO_FLAG::R, REG_TYPE::GEN, I2C_MST_STATUS_DATA>;
using INT_PIN_CFG = REGISTER_DESCRIPTION<0x37, IO_FLAG::RW, REG_TYPE::GEN, INT_PIN_CFG_DATA>;
using INT_ENABLE = REGISTER_DESCRIPTION<0x38, IO_FLAG::RW, REG_TYPE::GEN, INT_ENABLE_DATA>;
using INT_STATUS = REGISTER_DESCRIPTION<0x3A, IO_FLAG::R, REG_TYPE::GEN, INT_STATUS_DATA>;
using ACCEL_XOUT_H = REGISTER_DESCRIPTION<0x3B, IO_FLAG::R, REG_TYPE::GEN>;
using ACCEL_XOUT_L = REGISTER_DESCRIPTION<0x3C, IO_FLAG::R, REG_TYPE::GEN>;
using ACCEL_YOUT_H = REGISTER_DESCRIPTION<0x3D, IO_FLAG::R, REG_TYPE::GEN>;
using ACCEL_YOUT_L = REGISTER_DESCRIPTION<0x3E, IO_FLAG::R, REG_TYPE::GEN>;
using ACCEL_ZOUT_H = REGISTER_DESCRIPTION<0x3F, IO_FLAG::R, REG_TYPE::GEN>;
using ACCEL_ZOUT_L = REGISTER_DESCRIPTION<0x40, IO_FLAG::R, REG_TYPE::GEN>;
using TEMP_OUT_H = REGISTER_DESCRIPTION<0x41, IO_FLAG::R, REG_TYPE::GEN>;
using TEMP_OUT_L = REGISTER_DESCRIPTION<0x42, IO_FLAG::R, REG_TYPE::GEN>;
using GYRO_XOUT_H = REGISTER_DESCRIPTION<0x43, IO_FLAG::R, REG_TYPE::GEN>;
using GYRO_XOUT_L = REGISTER_DESCRIPTION<0x44, IO_FLAG::R, REG_TYPE::GEN>;
using GYRO_YOUT_H = REGISTER_DESCRIPTION<0x45, IO_FLAG::R, REG_TYPE::GEN>;
using GYRO_YOUT_L = REGISTER_DESCRIPTION<0x46, IO_FLAG::R, REG_TYPE::GEN>;
using GYRO_ZOUT_H = REGISTER_DESCRIPTION<0x47, IO_FLAG::R, REG_TYPE::GEN>;
using GYRO_ZOUT_L = REGISTER_DESCRIPTION<0x48, IO_FLAG::R, REG_TYPE::GEN>;
using EXT_SENS_DATA_00 = REGISTER_DESCRIPTION<0x49, IO_FLAG::R, REG_TYPE::GEN>;
using EXT_SENS_DATA_01 = REGISTER_DESCRIPTION<0x4A, IO_FLAG::R, REG_TYPE::GEN>;
using EXT_SENS_DATA_02 = REGISTER_DESCRIPTION<0x4B, IO_FLAG::R, REG_TYPE::GEN>;
using EXT_SENS_DATA_03 = REGISTER_DESCRIPTION<0x4C, IO_FLAG::R, REG_TYPE::GEN>;
using EXT_SENS_DATA_04 = REGISTER_DESCRIPTION<0x4D, IO_FLAG::R, REG_TYPE::GEN>;
using EXT_SENS_DATA_05 = REGISTER_DESCRIPTION<0x4E, IO_FLAG::R, REG_TYPE::GEN>;
using EXT_SENS_DATA_06 = REGISTER_DESCRIPTION<0x4F, IO_FLAG::R, REG_TYPE::GEN>;
using EXT_SENS_DATA_07 = REGISTER_DESCRIPTION<0x50, IO_FLAG::R, REG_TYPE::GEN>;
using EXT_SENS_DATA_08 = REGISTER_DESCRIPTION<0x51, IO_FLAG::R, REG_TYPE::GEN>;
using EXT_SENS_DATA_09 = REGISTER_DESCRIPTION<0x52, IO_FLAG::R, REG_TYPE::GEN>;
using EXT_SENS_DATA_10 = REGISTER_DESCRIPTION<0x53, IO_FLAG::R, REG_TYPE::GEN>;
using EXT_SENS_DATA_11 = REGISTER_DESCRIPTION<0x54, IO_FLAG::R, REG_TYPE::GEN>;
using EXT_SENS_DATA_12 = REGISTER_DESCRIPTION<0x55, IO_FLAG::R, REG_TYPE::GEN>;
using EXT_SENS_DATA_13 = REGISTER_DESCRIPTION<0x56, IO_FLAG::R, REG_TYPE::GEN>;
using EXT_SENS_DATA_14 = REGISTER_DESCRIPTION<0x57, IO_FLAG::R, REG_TYPE::GEN>;
using EXT_SENS_DATA_15 = REGISTER_DESCRIPTION<0x58, IO_FLAG::R, REG_TYPE::GEN>;
using EXT_SENS_DATA_16 = REGISTER_DESCRIPTION<0x59, IO_FLAG::R, REG_TYPE::GEN>;
using EXT_SENS_DATA_17 = REGISTER_DESCRIPTION<0x5A, IO_FLAG::R, REG_TYPE::GEN>;
using EXT_SENS_DATA_18 = REGISTER_DESCRIPTION<0x5B, IO_FLAG::R, REG_TYPE::GEN>;
using EXT_SENS_DATA_19 = REGISTER_DESCRIPTION<0x5C, IO_FLAG::R, REG_TYPE::GEN>;
using EXT_SENS_DATA_20 = REGISTER_DESCRIPTION<0x5D, IO_FLAG::R, REG_TYPE::GEN>;
using EXT_SENS_DATA_21 = REGISTER_DESCRIPTION<0x5E, IO_FLAG::R, REG_TYPE::GEN>;
using EXT_SENS_DATA_22 = REGISTER_DESCRIPTION<0x5F, IO_FLAG::R, REG_TYPE::GEN>;
using EXT_SENS_DATA_23 = REGISTER_DESCRIPTION<0x60, IO_FLAG::R, REG_TYPE::GEN>;
using I2C_SLV0_DO = REGISTER_DESCRIPTION<0x63, IO_FLAG::RW, REG_TYPE::GEN>;
using I2C_SLV1_DO = REGISTER_DESCRIPTION<0x64, IO_FLAG::RW, REG_TYPE::GEN>;
using I2C_SLV2_DO = REGISTER_DESCRIPTION<0x65, IO_FLAG::RW, REG_TYPE::GEN>;
using I2C_SLV3_DO = REGISTER_DESCRIPTION<0x66, IO_FLAG::RW, REG_TYPE::GEN>;
using I2C_MST_DELAY_CTRL = REGISTER_DESCRIPTION<0x67, IO_FLAG::RW, REG_TYPE::GEN, I2C_MST_DELAY_CTRL_DATA>;
using SIGNAL_PATH_RESET = REGISTER_DESCRIPTION<0x68, IO_FLAG::RW, REG_TYPE::GEN, SIGNAL_PATH_RESET_DATA>;
using ACCEL_INTEL_CTRL = REGISTER_DESCRIPTION<0x69, IO_FLAG::RW, REG_TYPE::GEN, ACCEL_INTEL_CTRL_DATA>;
using USER_CTRL = REGISTER_DESCRIPTION<0x6A, IO_FLAG::RW, REG_TYPE::GEN, USER_CTRL_DATA>;
using PWR_MGMT1 = REGISTER_DESCRIPTION<0x6B, IO_FLAG::RW, REG_TYPE::GEN, PWR_MGMT1_DATA>;
using PWR_MGMT2 = REGISTER_DESCRIPTION<0x6C, IO_FLAG::RW, REG_TYPE::GEN, PWR_MGMT2_DATA>;
using FIFO_COUNTH = REGISTER_DESCRIPTION<0x72, IO_FLAG::RW, REG_TYPE::GEN, FIFO_COUNTH_DATA>;
using FIFO_COUNTL = REGISTER_DESCRIPTION<0x73, IO_FLAG::RW, REG_TYPE::GEN>;
using FIFO_R_W = REGISTER_DESCRIPTION<0x74, IO_FLAG::RW, REG_TYPE::GEN>;
using WHOAMI = REGISTER_DESCRIPTION<0x75, IO_FLAG::R, REG_TYPE::GEN>;
using XA_OFFS_H = REGISTER_DESCRIPTION<0x77, IO_FLAG::RW, REG_TYPE::GEN>;
using XA_OFFS_L = REGISTER_DESCRIPTION<0x78, IO_FLAG::RW, REG_TYPE::GEN, A_OFFS_L_DATA>;
using YA_OFFS_H = REGISTER_DESCRIPTION<0x7A, IO_FLAG::RW, REG_TYPE::GEN>;
using YA_OFFS_L = REGISTER_DESCRIPTION<0x7B, IO_FLAG::RW, REG_TYPE::GEN, A_OFFS_L_DATA>;
using ZA_OFFS_H = REGISTER_DESCRIPTION<0x7D, IO_FLAG::RW, REG_TYPE::GEN>;
using ZA_OFFS_L = REGISTER_DESCRIPTION<0x7E, IO_FLAG::RW, REG_TYPE::GEN, A_OFFS_L_DATA>;

using MAG_WIA = REGISTER_DESCRIPTION<0x00, IO_FLAG::R, REG_TYPE::MAG>;
using MAG_INFO = REGISTER_DESCRIPTION<0x01, IO_FLAG::R, REG_TYPE::MAG>;
using MAG_ST1 = REGISTER_DESCRIPTION<0x02, IO_FLAG::R, REG_TYPE::MAG, MAG_ST1_DATA>;
using MAG_XOUT_L = REGISTER_DESCRIPTION<0x03, IO_FLAG::R, REG_TYPE::MAG>;
using MAG_XOUT_H = REGISTER_DESCRIPTION<0x04, IO_FLAG::R, REG_TYPE::MAG>;
using MAG_YOUT_L = REGISTER_DESCRIPTION<0x05, IO_FLAG::R, REG_TYPE::MAG>;
using MAG_YOUT_H = REGISTER_DESCRIPTION<0x06, IO_FLAG::R, REG_TYPE::MAG>;
using MAG_ZOUT_L = REGISTER_DESCRIPTION<0x07, IO_FLAG::R, REG_TYPE::MAG>;
using MAG_ZOUT_H = REGISTER_DESCRIPTION<0x08, IO_FLAG::R, REG_TYPE::MAG>;
using MAG_ST2 = REGISTER_DESCRIPTION<0x09, IO_FLAG::R, REG_TYPE::MAG, MAG_ST2_DATA>;
using MAG_CNTL1 = REGISTER_DESCRIPTION<0x0A, IO_FLAG::RW, REG_TYPE::MAG, MAG_CNTL1_DATA>;
using MAG_CNTL2 = REGISTER_DESCRIPTION<0x0B, IO_FLAG::RW, REG_TYPE::MAG, MAG_CNTL2_DATA>;
using MAG_ASTC = REGISTER_DESCRIPTION<0x0C, IO_FLAG::RW, REG_TYPE::MAG, MAG_ASTC_DATA>;
using MAG_TS1 = REGISTER_DESCRIPTION<0x0D, IO_FLAG::RW, REG_TYPE::MAG>;
using MAG_TS2 = REGISTER_DESCRIPTION<0x0E, IO_FLAG::RW, REG_TYPE::MAG>;
using MAG_I2CDIS = REGISTER_DESCRIPTION<0x0F, IO_FLAG::RW, REG_TYPE::MAG>;
using MAG_ASAX = REGISTER_DESCRIPTION<0x10, IO_FLAG::R, REG_TYPE::MAG>;
using MAG_ASAY = REGISTER_DESCRIPTION<0x11, IO_FLAG::R, REG_TYPE::MAG>;
using MAG_ASAZ = REGISTER_DESCRIPTION<0x12, IO_FLAG::R, REG_TYPE::MAG>;
...
class MPU9250 {
    public:
        ...
        // TODO: Create functions to enable/disable motion detection (see 6.1 at Product Specification)
        ...
        bool accelerometerXIsEnabled();
        bool accelerometerYIsEnabled();
        bool accelerometerZIsEnabled();
    ...
    protected:
        ...
        template<typename T>
        void writeRegister(T& t);

        template<typename H, typename L>
        uint16_t mergeTwoRegistersU();

        template<typename H, typename L>
        int16_t mergeTwoRegistersS();

    private:
        template<typename T, typename F>
        void updateRegister(F func);      // Captured lambdas are not functions =\

        // template<typename T, typename F>
        // auto parseRegister(F func) -> decltype(auto);
